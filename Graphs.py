...
def create_random_gene_node_flowchart():
    ...
    dot.node("G", "Is new_segment_score < min_fitness_score\nand regen_count < node_re_gen_max?")
    ...
    dot.node("M", "Return False, min_fitness_score * 2")
    ...
    dot.node("U", "Did recursive call succeed\nand is new_segment_score ≥ min_fitness_score?")
    dot.node("V", "Return False, min_fitness_score * 2")
...
def create_random_gene_flowchart():
    ...
    dot.node("J", "Set root_score = 2 * min_fitness_score")
